  ...
  readCurrentDriverInformation() async {
    ...
    await FirebaseDatabase.instance
      ...
      if (snap.snapshot.value != null) {
        ...
        if ((snap.snapshot.value as Map)["isBanned"] ?? false == true) {
          Fluttertoast.showToast(msg: "You are Banned by Admin");
              ...
              ElevatedButton(
                onPressed: () {
                  if (isDriverActive != true) //offline
                  {
                    log("isDriverActive");
                    driverIsOnlineNow();
                    log("driverIsOnlineNow");
                    updateDriversLocationAtRealTime();
                    log("updateDriversLocationAtRealTime");
